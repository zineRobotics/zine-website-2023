        ...
        <div className="text-black text-center -mt-120">
            <div className="grid grid-cols-5 pb-32">
                <div className="col-span-1 pl-8 -mt-24">
                    <Link href="https://github.com/"><div className="cursor-pointer w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter">
                        <div className="text-6xl mt-24 text-center pt-24">Events</div>
                    </div></Link>
                </div>

                <div className="col-span-4">
                    <div className="mr-32 ml-16 text-3xl h-72 bg-purple-300 rounded-lg mix-blend-multiply filter">
