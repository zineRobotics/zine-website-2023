...
const RegistrationBanner = () => {
  return(
    <div className="bg-banner-bg bg-center bg-cover py-28">
      ...
      <Link href="https://www.instagram.com/zine.robotics/"><span className="underline cursor-pointer">Follow</span></Link> our social media handles for updates regarding workshops and recruitment.
      </div>
    </div>
  )
}
