    ...
    return(
        <div className="text-black bg-white w-screen">
          ...
          <div className="mx-8 md:mx-16 lg:mx-32 mt-8 text-lg">
            ...
            <p>Yeah, guys! we know all of you know it's a brick. But what about these? Can you tell their smallest electronic component?</p>

            <p className="text-red-600 my-8">Two big images will come here.</p>

            <p>Or we may reframe our question as to what is the building block of all major electronic devices?</p>
