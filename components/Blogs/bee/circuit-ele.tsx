          ...
          <div className="mx-32 mt-8 text-lg">
            ...
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-2">
                <p className="text-red-600">One image will come here.</p>
              </div>
            </div>
            <br />
            <div className="grid grid-cols-12">
            ...
            <div className="grid grid-cols-12">
              <div className="col-span-10">
                <p>Suppose you connect a switch in series with your circuit, but the simple on/off switch can only have two states, on or off, and takes only one of them at once.</p>
                <p className="text-red-600">Two images will come here.</p>
              </div>
            </div>
            <br />
            <br />
            <p className="border-2 border-solid border-black px-4">A quick question - would the arrangement still be called a circuit if I set the switch in the OFF state? There is no flow of electric current, so it defies the definition of a circuit. Try and think by yourself! If it is, why? Consider this as an assignment to yourself. Contact us with your doubts.</p>

            <br />
            <br />

            <p>Now that you know what exactly is a circuit, let’s study the types of circuit elements.</p>
            <br />
            <br />
            <div className="grid grid-cols-2 gap-8">
              <div className="col-span-1">
                ...
                <br />
                <p>Let’s now study these elements one by one</p>
              </div>
              <div className="col-span-1">
                ...
                <br />
                <br />
                <h1 className="text-3xl">Passive Circuit Elements</h1>
                <br />
            ...
            <div className="grid grid-cols-2 gap-8 mt-8">
              <div className="col-span-1">
                ...
                <br />
                <br />
                <p>Symbols- Two common resistor schematic symbols. R1 is an American-style 1kΩ resistor, and R2 is an international-style 47kΩ resistor.</p>
                <br />
                <br />
            ...
            <p>These are resistors-</p>
            <p className="text-red-600">One big image will come here.</p>
            <br />
            <p>You see the different colored stripes on them. Many of you might know why they are for it. Yes! They are for determining their resistances.</p>
            <br />
            <p>Fun Fact: But do you know that resistors may contain 3 to 6 colored strips. The table given below might come in handy.</p>
            <p className="text-red-600">One big image will come here.</p>
            <br />
            <p>Let’s discuss different types of resistors.</p>

            <h1 className="text-3xl my-8">Carbon Film Resistors</h1>
            <br />
            <p className="text-red-600">One big image will come here.</p>
            <br />
            ...
            <br />
            <p className="border-2 border-solid border-black px-4">And, we have an assignment for you, try to figure out what is the use of zero ohm resistors in circuits</p>
            ...
            <h1 className="text-4xl my-8">Capacitors</h1>
            <br />
            <p className="text-red-600">One big image will come here.</p>
            <br />
            <p className="text-red-600">One big image will come here.</p>
            ...
            <h1 className="text-3xl my-8">Axial Lead Type Capacitors</h1>
            <div className="grid grid-cols-5">
              <div className="col-span-2">
                <p className="text-red-600">One big image will come here.</p>
              </div>
            ...
            <h1 className="text-3xl my-8">Ceramic Capacitors</h1>
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="col-span-1">
                <p>Electrolytic capacitors are made of two aluminum foils and a paper spacer soaked in electrolyte. One of the two aluminum foils is covered with an oxide layer, and that foil acts as the anode, while the uncoated one acts as a cathode.

                  <br />

                These capacitors have the highest level of capacitance per unit volume. Electrolytic capacitors are polarised, i.e. they can only be placed one way round in the circuit. You studied many types of capacitors. But, how do we identify the capacitance of the capacitor just by seeing it? You can refer to this for information about it.

                <br />

                Huh!🤕 A lot of components for one blog. Ok...ok...let’s end this blog here and see you in the next blog with some more parts of “heart”.</p>
              </div>
            </div>
