...
import { year2009, year2010, year2011, year2012, year2016, year2017, year2018, year2019, year2020, year2021, year2022, year2023, year2024, year2025 } from '../../constants/members'
...
const Alumni = () => {
    return(
      <div className="text-black bg-white justify-center pb-16">
        ...
        <h1 className="pt-12 text-center font-bold text-4xl px-12 lg:px-24">2025</h1>
