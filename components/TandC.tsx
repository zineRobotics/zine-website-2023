...
const TandC = () => {
  return (
    <div className="px-5 py-2 rounded-md border border-black m-5">
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of Zine's Website, located at{" "}
        <a href="https://zine.co.in" target="_blank">
          zine.co.in
        </a>
        .
      </p>

      <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Zine if you do not agree to take all of the terms and conditions stated on this page.</p>
      ...
      <p>
        ...
        express purpose of meeting the Client's needs in respect of provision of the Company's stated services, in accordance with and subject to, prevailing law of in. Any use of the above
      ...
      <p>We employ the use of cookies. By accessing Zine, you agreed to use cookies in agreement with the Zine's Privacy Policy. </p>
      ...
      <p>
        Unless otherwise stated, Zine and/or its licensors own the intellectual property rights for all material on Zine. All intellectual property rights are reserved. You may access this from Zine
        for your own personal use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Zine</li>
        <li>Sell, rent or sub-license material from Zine</li>
        <li>Reproduce, duplicate or copy material from Zine</li>
        <li>Redistribute content from Zine</li>
      </ul>
      ...
      <p>
        Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Zine does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and opinions of Zine,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, Zine shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any
        use of and/or posting of and/or appearance of the Comments on this website.
      </p>

      <p>Zine reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
      ...
      <p>You hereby grant Zine a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
      ...
      <p>
        ...
        does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Zine; and (d) the link is in the context of general resource
        information.
      </p>
      ...
      <p>
        If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Zine. Please include your name, your
        organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would
      ...
      <p>No use of Zine's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
