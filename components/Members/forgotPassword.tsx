        ...
        <div className="flex flex-col items-center" style={{background: "linear-gradient(to right, #003D63, #0C72B0)"}}>
            ...
            <div className="bg-white rounded-xl px-8 pb-8 md:px-16 my-16 w-11/12 md:w-1/2" style={{maxWidth: 651}}>
                ...
                <form>
                    ...
                    <button className="mt-8 p-4 block w-full rounded-3xl text-white" onClick={handleSubmit(onSubmit)} style={{background: "#0C72B0"}}>Forgot Password</button>
                    <p className="mt-8 text-sm text-center">
                        <Link href="/login"><a className="text-blue-500 underline">Back to login</a></Link>
                    </p>
                </form>
            </div>
        </div>
