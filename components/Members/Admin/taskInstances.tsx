...
const TaskInstances = () => {
  ...
  const [userInstance, setUserInstance] = useState<ITaskInstanceData>();
...
//   const userTasksCollection = collection(db, "userTasks");
  ...
  const deleteUserInstance = async () => {
    ...
    await toast.promise(deleteInstances(userInstance.taskId.id, [userInstance.taskInstanceId]), {
    ...
    <ProtectedRoute>
      ...
      <div className="grid grid-cols-12 h-screen" style={{ background: "#EFEFEF" }}>
        <div className="col-span-12 md:col-span-9 px-6 md:px-12 flex flex-col overflow-y-scroll">
            ...
            <div className="my-8">
              ...
              <div className="grid grid-cols-1 text-center md:grid-cols-3 gap-6 mt-2">
                ...
                //   .sort((a, b) => sortTimestamps(b.checkpoints, a.checkpoints))
                  .map((p) => (
                    <div key={p.taskInstanceId} className="bg-white rounded-xl flex flex-col justify-center py-2 cursor-pointer" onClick={() => setUserInstance(p)}>
          ...
          {userInstance && (
            <p>add the checkpoint thing here</p>
            // <>
