...
const Channels = () => {
  type KeyValueArray = Array<{ id: string; data: IMessageData }>;
    ...
    function RenderMessageWithLinks({ message, user, space, name, id, text}: {message: string, user: boolean, space: boolean, name: string,id: string,text: string,}) {
      return (
        <Draggable
                                          axis="x"
                                          bounds={{
        ...
        <div className="whitespace-pre-wrap break-words pl-3 text-white" style={{cursor: "pointer", userSelect:"none"}}>
        ...
        <div className='flex h-screen md:col-span-9' >
          <div className="w-60 bg-white shrink-0 px-3 pt-10 flex justify-center">
            <div className='w-full'>
                ...
                > 
                <div className="w-6 h-5 rounded mr-2 object-fill bottom-0" style={{backgroundColor: "#fff"}}>
                <Image src={ChatDP}/>
                </div>
                  {"Announcements"}
                  </p>
          ...
          <div className="bg-white flex align-center py-3">
            <div className="w-8 h-8 mr-2 ml-6 object-fill rounded-xl align" style={{backgroundColor: "#0C72B0"}}>
            {
                      currRoomImage ? 
                      ...
                      messages?.map((msg, idx, array )=> {
                                ...
                                return (
                                    <div className="pl-7 mt-2" key={msg.data.timeStamp.seconds}>
                                        ...
                                        <div className="w-6 h-6 bg-white mr-2 bottom-0 rounded object-contain">
                                          <Image src={ChatDP}/>
                                        </div>
